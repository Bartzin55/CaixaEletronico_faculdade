    ...
    match escolha:
        ...
        case '2':
            ...
            while loginfeito == True:
                ...
                iduser = DataBaseContas.coletarid(nomeusuario)

                funcoesbasicas.line()
                print(f'Bem vindo {nomeusuario}! | Login efetuado em {tempo}')
                saldoatual = DataBaseContas.coletarsaldo(iduser)
                ...
                match escolha:
                    ...
                    case '1': #depositar valor
                        ...
                        entradavalor = input('Digite o valor que deseja depositar: ')
                        try:
                        ...
                        if valor <= 0:
                            ...
                            DataBaseContas.depositarvalor(iduser, valor)
                            novosaldo = DataBaseContas.coletarsaldo(iduser)
                    ...
                    case '2': #sacar valor
                        ...
                        entradasaldorequerido = input('Digite o valor que você deseja sacar: ')
                        try:
                    ...
                    case '3':
                        while True:
                            os.system('cls')
                            funcoesbasicas.line()
                            iddestino = input('Digite o ID do usuário que você deseja reealizar a transferência, digite "0" para cancelar a operação: ')
                            if iddestino == '0':
                                os.system('cls')
                                funcoesbasicas.line()
                        ...
                        while condicao == False:
                            ...
                            if numerocartao != None:
                                ...
                                if condicao == False:
                                    ...
                                    numerocartao, validade, cvv = GeradorDeCartao.gerarcartao(iduser, senhacartao)
